...
public class StudentDao {
	...
	public ArrayList<StudentDto> getSearchingGrade(int grade,String t_name) {
		ArrayList<StudentDto> dtos = new ArrayList<StudentDto>();
		String sql = "select * from student_황희원 where syear ='"+grade+"' and name like'%"+t_name+"%' order by sclass,sno";
	...
	public ArrayList<StudentDto> getSearchingName(String searchingName) {
		ArrayList<StudentDto> dtos = new ArrayList<StudentDto>();
		String sql = "select * from student_황희원 where name like'%"+searchingName+"%' order by syear , sclass, sno";
